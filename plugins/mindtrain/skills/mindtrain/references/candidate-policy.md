...
The explanation must contain conclusion, four option analyses with matching correctness flags, mechanism steps, pitfalls, version notes, and related topic IDs.
